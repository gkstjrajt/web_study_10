...
public class TitleDaoImpl implements TitleDao {
	...
	public List<Title> SelectTitleByAll() {
		String sql = "SELECT TITLE_NO, TITLE_NAME FROM TITLE ORDER BY TITLE_NO";
			try(Connection con = JndiDS.getConnection();				// db에 연결
					PreparedStatement pstmt = con.prepareStatement(sql)){	// db에 날릴 준비
